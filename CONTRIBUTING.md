...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/NEW-REPO-NAME.git
cd NEW-REPO-NAME

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/NEW-REPO-NAME.git
